@extends('layouts.app')
@section('content')
<!-- não vejo sentido nenhum dessa view, vem do ranking da gincana, tmb nao tem necessidade pq se ta na gincana já participou, logo nao precisa ver a gincana, que aliás esta para uma view errada--->

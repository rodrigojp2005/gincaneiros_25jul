<x-guest-layout>
    ...
    <div class="mt-6 flex flex-col items-center">
        <a href="{{ route('auth.google') }}" class="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-md shadow hover:bg-red-700 transition-all duration-200">
